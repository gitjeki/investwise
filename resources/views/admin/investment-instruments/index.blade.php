...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Manage Investment Instruments</h1>
    <a href="{{ route('admin.investment-instruments.create') }}" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-full shadow transition mb-6 inline-block">Add New Instrument</a>
            ...
            <tbody>
                @forelse ($instruments as $instrument)
                    <tr>
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <a href="{{ route('admin.investment-instruments.edit', $instrument->id) }}" class="text-blue-600 hover:text-blue-900 mr-3">Edit</a>
                            {{-- Ubah tombol delete untuk memanggil fungsi JavaScript --}}
                            <button type="button" onclick="openDeleteModal('{{ $instrument->id }}', '{{ $instrument->name }}')" class="text-red-600 hover:text-red-900">Delete</button>
                        </td>
                    </tr>
                @empty
                    <tr>
    ...
    <div id="deleteModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center z-50 hidden">
        <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-sm">
            <div class="text-center">
                ...
                {{-- Form DELETE sebenarnya akan ada di sini, aksi akan diisi oleh JavaScript --}}
    ...
    <script>
        ...
        function openDeleteModal(itemId, itemName) {
            ...
            deleteForm.action = "{{ route('admin.investment-instruments.destroy', ':id') }}".replace(':id', itemId);
