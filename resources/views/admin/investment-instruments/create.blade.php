...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Add New Investment Instrument</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <form action="{{ route('admin.investment-instruments.store') }}" method="POST">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="type" id="type" value="{{ old('type') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            ...
            @forelse ($criterias as $criteria)
                <div class="mb-4">
                    ...
                    <input type="number" name="criteria_scores_{{ $criteria->id }}" id="criteria_scores_{{ $criteria->id }}" value="{{ old('criteria_scores_' . $criteria->id) }}" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
